...
#knitr::opts_knit$set(root.dir = "C:/Users/Sean Reid/Box/UCSB_new/Winter23/esm263/hw1/images")
#knitr::opts_knit$set(root.dir = "C:/Users/Sean Reid/Downloads")
```
...
```{r image_1, fig.show = "hold", out.width = "50%", out.height="20%", fig.align = "default", echo=FALSE} 
knitr::include_graphics(c("images/medianage_albers.png","images/giniwgs84.png"))
```
...
```{r image_2, fig.show = "hold", out.width = "50%", out.height="20%", fig.align = "default", echo=FALSE} 
knitr::include_graphics(c("images/misleading.jfif","images/betterelection.jpg"))
```
...
```{r image_3, fig.show = "hold", out.width = "50%", out.height="20%", fig.align = "default", echo=FALSE} 
knitr::include_graphics(c("images/btu_classes.png", "images/energyconsumption_developed.png"))
```
...
```{r image_4, fig.show = "hold", out.width = "50%", out.height="20%", fig.align = "default", echo=FALSE} 
knitr::include_graphics(c("images/good_colors.png", "images/muted_colors.png"))
```
...
```{r image_5, fig.show = "hold", out.width = "50%", out.height="20%", fig.align = "default", echo=FALSE} 
knitr::include_graphics(c("images/greatmap.png", "images/twocolor_scalebar.png"))
```
...
```{r image_6, fig.show = "hold", out.width = "50%", out.height="20%", fig.align = "default", echo=FALSE} 
knitr::include_graphics(c("images/btu_classes.png", "images/toofew_classes.png"))
```
...
```{r image_7, fig.show = "hold", out.width = "50%", out.height="20%", fig.align = "default", echo=FALSE} 
knitr::include_graphics("images/twocolor_scalebar.png")
```
